...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        //ffmpeg的路径
        String ffmpeg_path = "E:\\BaiduNetdiskDownload\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\video\\douga.mp4";
        //转换后mp4文件的名称
        String mp4_name = "douga.avi";
        //转换后mp4文件的路径
        String mp4_path = "D:\\video\\douga.avi";
        //创建工具类对象
